...
odabrana_velicina = 'Engine Size (L)' 
...
ax2.set_xlabel('Standardizirana vrijednost (0-1)')
...
# e) Izvršite procjenu izlazne veliˇcine na temelju ulaznih velicina skupa za testiranje. Prikažite pomocu dijagrama raspršenja odnos izmedu stvarnih vrijednosti izlazne velicine i procjene dobivene modelom.
